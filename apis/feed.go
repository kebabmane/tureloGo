...
type (
	...
	feedService interface {
		...
		Create(rs app.RequestScope, model *models.Feed) (*models.Feed, error)
		Update(rs app.RequestScope, id int, model *models.Feed) (*models.Feed, error)
		Delete(rs app.RequestScope, id int) (*models.Feed, error)
	}
